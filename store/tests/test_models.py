...
class TestProductsModel(TestCase):
    def setUp(self):
        ...
        User.objects.create(email="admin@admin.com", user_name="admin")
        self.data1 = Product.objects.create(category_id=1, title="django beginners", created_by_id=1,
                                            slug="django-beginners", price="20.00", image="django")
        self.data2 = Product.objects.create(category_id=1, title="react beginners", created_by_id=1,
                                            slug="react-beginners", price="20.00", image="react", is_active=False)
    ...
    def test_products_custom_manager_basic(self):
        """
        Test product mdoel custom manager returns only active products
        """
